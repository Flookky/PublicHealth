package com.example.publichealth.utils.Printer.Bixolon;
...
//        if (main != null){
//            main.setDeviceLog("DirectIO: " + directIOEvent + "(" + getBatterStatusString(directIOEvent.getData()) + ")");
//        }
...
//        MainActivity main = new MainActivity();
//        if (main != null){
//            main.setDeviceLog("Error : " + errorEvent);
//        }
...
//        MainActivity main = new MainActivity();
//        if (main != null){
//            main.setDeviceLog("outputComplete : " + outputCompleteEvent.getOutputID());
//        }
...
//        MainActivity main = new MainActivity();
//        if (main != null){
//            main.setDeviceLog(getSUEMessage(statusUpdateEvent.getStatus()));
//        }

        status = getSUEMessage(statusUpdateEvent.getStatus());
...
//
//            main.setDeviceLog(track1 + track2 + track3);
//        }
